...
[![Tests](https://img.shields.io/badge/Tests-177%20passed%20%7C%2042%20subtests-brightgreen.svg)](tests/)
...
### Schnellnavigation
[Schnellstart](#schnellstart) · [Architektur & Yard-Struktur](#die-yard-struktur) · [Die 10 Regeln](#die-zehn-regeln-kurzfassung) · [Täglicher Sync-Lebenszyklus](#t%C3%A4glicher-sync--reconciliation-lebenszyklus) · [Instanz-Lebenszyklus](#kontrollierter-repo-zu-yard-lebenszyklus) · [Konfliktkopien-Reconciler](#sichere-abstimmung-von-konfliktkopien) · [Trusted-Peer-Pfade](#trusted-peer-pull-vorbereitung) · [Republica Fallback](#republica-showcase-fallback) · [Sicherheitsrichtlinie](SECURITY.md) · [LLM-Kontext](llms.txt) · [Ökosystem-Matrix](#verwandte-werkzeuge--%C3%B6kosystem)
...
yard-instance-manager plan \
  ...
  --template-root /pfad/zu/system-gap-master/template \
...
versionierten `template/YARD_TEMPLATE.json`, klassifiziert die oberste
...
geprüft. Aktualisierungen erhalten hostlokale Backups, atomare Ersetzung und
eine Rollback-Operation. Lokal veränderte verwaltete Dateien blockieren den
